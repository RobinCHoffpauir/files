...
class Stocks:
    ...
    def get_stocks(self, ticker1, start, multipleplots=None, end=None, ticker2=None, ticker3=None, ticker4=None):
        """
        ...
        ----------
        ticker1 : TYPE-['str']
        DESCRIPTION-a single  stock ticker symbol(s) ex.'msft'.
        start : TYPE-datetime
        DESCRIPTION-iso format of datetime that is the first day that stock data will be collected.
        multipleplots : TYPE-Boolean (True/False)
        DESCRIPTION-OPTIONAL-True=each stock displays seperate plot, False=stocks display on one plot.
        end : TYPE-datetime
        DESCRIPTION-OPTIONAL-iso format of datetime that is the last day that stock data will be collected.
        ticker2 : TYPE-['str']
        DESCRIPTION-OPTIONAL-a single  stock ticker symbol(s) ex.'msft'
        ticker3 : TYPE-['str']
        DESCRIPTION-OPTIONAL-a single  stock ticker symbol(s) ex.'msft'
        ticker4 : TYPE-['str']
        DESCRIPTION-OPTIONAL-a single  stock ticker symbol(s) ex.'msft'
